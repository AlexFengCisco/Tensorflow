...
from pyang.plugins.omni import fullpath
from objc._category import Category
...
MODEL_DIR = '/Users/AlexFeng/git/Tensorflow/inception-v3'
MODEL_FILE = 'tensorflow_inception_graph.pb'
CACHE_DIR = '/tmp/bottleneck'

INPUT_DATA = '/Users/AlexFeng/git/Tensorflow/flower_photos'
...
def get_bottleneck_path(image_lists,lable_name,index,category):
    ...
    return get_image_path(image_lists,CACHE_DIR,lable_name,index,category)+'.txt'
